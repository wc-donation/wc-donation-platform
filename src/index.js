  ...
  edit(props) {
    ...
    return (
      <Fragment>
          ...
          <PanelBody title={__("General Settings", "wc-donation-platform")}>
            ...
            <SelectControl
              ...
              options={[
                {
                  label: __(
                    "Style 1 (3 steps, progress header)",
                    "wc-donation-platform",
                  ),
                  value: "1",
                },
                {
                  label: __("Style 2 (one page)", "wc-donation-platform"),
                  value: "2",
                },
                {
                  label: __(
                    "Style 3 (3 steps, no header)",
                    "wc-donation-platform",
                  ),
                  value: "3",
                },
            ...
            />
            <SelectControl
              label={__("Theme", "wc-donation-platform")}
              value={theme}
              options={[
                {
                  label: __("Theme 1 (Default)", "wc-donation-platform"),
                  value: "1",
                },
                {
                  label: __("Theme 2 (Modern Buttons)", "wc-donation-platform"),
                  value: "2",
                },
              ]}
            ...
            <ToggleControl
              ...
              checked={button}
              help={__(
                "Applies only if popup is enabled",
                "wc-donation-platform",
              )}
        ...
        <p {...useBlockProps()}>
          {__(
            "Your donation form will be displayed here.",
            "wc-donation-platform",
          )}
        </p>
      </Fragment>
