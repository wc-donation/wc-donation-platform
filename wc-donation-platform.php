        ...
        public static function wcdp_inactive_notice() {
            if ( current_user_can( 'activate_plugins' ) ) {
                ...
                if ( ! is_woocommerce_active() ) {
                    ...
                    $admin_notice_content = sprintf( esc_html__( 'Donation Platform for WooCommerce is inactive. This version of Donation Platform for WooCommerce requires WooCommerce %s or newer. Please update WooCommerce & the WooCommerce database.', 'wc-donation-platform' ), self::$wc_minimum_supported_version );
                }
