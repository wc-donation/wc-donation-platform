...
if ($value['short_description']) {
    ?>
    <p class="wcdp-short-description wcdp-row">
...
?> autocomplete="off" enctype='multipart/form-data'
    ...
    <button style="display:none !important;" type="submit" name="add-to-cart"
        value="<?php echo esc_attr($product->get_id()); ?>" class="single_add_to_cart_button button alt"></button>
