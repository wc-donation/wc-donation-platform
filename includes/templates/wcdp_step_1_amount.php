...
<div id="wcdp_va_amount" class="wcdp_variation wcdp-row">
	...
	if ($amount_layout == 3) { //Expert design - action wcdp_custom_html_amount
		...
		<div class="wcdp-amount">
			...
			?>
			<input id="wcdp-range" aria-hidden="true" type="range" step="<?php echo (float) apply_filters('wcdp_range_slider_steps', 1); ?>" min="<?php echo $min_donation_amount ?>" max="<?php echo $max_range ?>">
		</div> <?php
