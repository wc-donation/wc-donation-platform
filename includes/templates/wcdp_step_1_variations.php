    ...
    ?>
        <div class="variations wcdp_variation wcdp-row">
            <?php if ($attributeLayout != 2): //No Label for Custom HTML ?>
                <label class="wcdp-variation-heading" for="<?php echo $esc_attribute; ?>"><?php echo wc_attribute_label( $attribute, $product ); ?></label>
            <?php else :
                //Display Custom HTML
            ...
            <div <?php if ($attributeLayout != 0) { echo 'style="display:none"'; } //Hide for other Layouts ?>>
