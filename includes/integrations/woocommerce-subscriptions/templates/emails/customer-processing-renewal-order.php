...
<?php /* translators: %s: Order number */ ?>
    <p><?php printf(esc_html__('Just to let you know &mdash; we\'ve received your donation renewal #%s, and it is now being processed:', 'wc-donation-platform'), esc_html($order->get_order_number())); ?></p>
