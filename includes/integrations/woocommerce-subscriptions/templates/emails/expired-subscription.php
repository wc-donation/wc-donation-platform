...
<?php /* translators: $1: customer's billing first name and last name */ ?>
    <p><?php printf(esc_html__('A recurring donation belonging to %1$s has expired. Their recurring donation\'s details are as follows:', 'wc-donation-platform'), esc_html($subscription->get_formatted_billing_full_name())); ?></p>
    ...
    <table class="td" cellspacing="0" cellpadding="6"
        ...
        <tr>
            ...
            <th class="td" scope="col"
                style="text-align:left;"><?php echo esc_html_x('End Date', 'table headings in notification email', 'woocommerce-subscriptions'); ?></th>
        </tr>
        </thead>
        <tbody>
        <tr>
