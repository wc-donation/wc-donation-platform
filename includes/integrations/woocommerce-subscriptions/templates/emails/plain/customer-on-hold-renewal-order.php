...
echo esc_html__( 'Thanks for your renewal donation. It’s on-hold until we confirm that payment has been received. In the meantime, here’s a reminder of your donation:', 'wc-donation-platform' ) . "\n\n";
