...
printf( __( 'A recurring donation belonging to %1$s has been suspended by the user. Their recurring donation\'s details are as follows:', 'wc-donation-platform' ), $subscription->get_formatted_billing_full_name() );
