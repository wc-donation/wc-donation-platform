...
<p><?php printf( esc_html__( 'A recurring donation belonging to %1$s has been cancelled. Their recurring donation\'s details are as follows:', 'woocommerce-subscriptions' ), esc_html( $subscription->get_formatted_billing_full_name() ) );?></p>

<table class="td" cellspacing="0" cellpadding="6" style="width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" border="1">
	<thead>
		<tr>
			<th class="td" scope="col" style="text-align:left;"><?php esc_html_e( 'Recurring Donation', 'wc-donation-platform' ); ?></th>
			<th class="td" scope="col" style="text-align:left;"><?php echo esc_html_x( 'Amount', 'table headings in notification email', 'wc-donation-platform' ); ?></th>
			<th class="td" scope="col" style="text-align:left;"><?php echo esc_html_x( 'Last Donation Date', 'table heading', 'wc-donation-platform' ); ?></th>
