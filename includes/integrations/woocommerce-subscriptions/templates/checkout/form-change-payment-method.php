	...
	<div id="payment">
		...
		<?php if ( $available_gateways ) : ?>
			...
			<span class="update-all-subscriptions-payment-method-wrap">
				...
				$label = sprintf( esc_html__( 'Update the payment method used for %1$sall%2$s of my current regular donation.', 'wc-donation-platform' ), '<strong>', '</strong>' );
