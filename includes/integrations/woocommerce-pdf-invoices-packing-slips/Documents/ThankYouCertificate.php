...
if (!class_exists('ThankYouCertificate')):
     ...
     */
    class ThankYouCertificate extends OrderDocumentMethods
    {
        protected static $_instance = null;

        /**
         * Create only one instance of ThankYouCertificate
         * @return ThankYouCertificate|null
         */
        public static function instance(): ?ThankYouCertificate
        {
...
return ThankYouCertificate::instance();
