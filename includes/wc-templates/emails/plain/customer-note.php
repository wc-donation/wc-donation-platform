...
echo esc_html__( 'The following note has been added to your donation:', 'wc-donation-platform' ) . "\n\n";
...
echo esc_html__( 'As a reminder, here are your donation details:', 'wc-donation-platform' ) . "\n\n";
